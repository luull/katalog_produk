            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">Log In Mitrasalur</h1>
                        <p class="">Log in to your Mitrasalur Area .</p>
                        @if (session('message'))
                        ...
                        @endif
                        <form class="text-left" action="{{ route('prosesloginbranch') }}" method="post">
                            @csrf
                            <div class="form">

                                <div id="username-field" class="field-wrapper input">
                                    <label for="username">Kode Mitrasalur</label>
