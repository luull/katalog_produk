                    ...
                    <table id="dt-table" class="table dt-table-hover" style="width:100%">
                        ...
                        <tbody>
                            @foreach ($data as $dt)
                                <tr>
                                    <td>{{ $dt->periode }}</td>
                                    <td align="right">{{ number_format($dt->tot_sub_total) }}</td>
                                    <td align="right">{{ number_format($dt->tot_total_ongkir) }}</td>
                                    <td align="right">{{ number_format($dt->tot_total) }}</td>
                                    <td align="right">{{ number_format($dt->tot_unix_code) }}</td>
                                    <td align="right">{{ number_format($dt->tot_total_bayar) }}</td>
