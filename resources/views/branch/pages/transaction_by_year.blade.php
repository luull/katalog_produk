    ...
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
            <nav class="breadcrumb-one" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><span>Data Transaksi Per Tahun</span></li>
                </ol>
            </nav>
        </div>
        <div class="col-xl-12 col-md-12 col-sm-12  layout-spacing">
            ...
            <div class="widget-content widget-content-area py-4 px-4 br-6">
                <div class="container">
                    <form action="{{ route('process-transaction-by-year') }}" method="POST">
                        @csrf
                        <div class="card col-md-12">

                            <div class="card-body">
                                <h4>Data Transaction Per Tahun </h4>
                                <hr>
                                <div class="row">
