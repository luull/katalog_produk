        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-item flex-row search-ul">
                <li class="nav-item align-self-center search-animated">
                    ...
                    <form class="form-inline search-full form-inline search" role="search" action="{{ route('findproduk') }}"  method="GET">
                        <div class="search-bar">
                            <input type="text" class="form-control search-form-control ml-lg-auto" name="search" value="{{ $search ?? '' }}" placeholder="Search...">
                        </div>
            ...
            <ul class="navbar-item flex-row navbar-dropdown">
                ...
                <li class="nav-item ml-3 mr-4">
                    <a href="/login" class="btn btn-success mt-2">Masuk</a>
                </li>
                @else
