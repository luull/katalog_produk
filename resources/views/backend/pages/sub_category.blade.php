    ...
    <div class="col-xl-12 col-lg-12 col-12 mb-5">
        <nav class="breadcrumb-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><span>Sub Kategori</span></li>
            </ol>
        </nav>
    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/backend/subcategory/delete/{{$d->id}}" alt="Delete"><i data-feather="trash" class="text-danger"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Kategori</label>
                                <select name="edit_id_category" id="edit_id_category" class="form-control">
                                    @foreach ($category as $c )
                                    <option value="{{$c->id}}">{{$c->name}}</option>
                                    @endforeach
                                </select>
    ...
    function edit(id){
          ...
          // var url="<?PHP echo env('APP_URL');?>/";
            ...
            $.ajax({
                type:'get',
                method:'get',
                url: '/backend/subcategory/find/'  + id ,
                data:'_token = <?php echo csrf_token() ?>'   ,
                success:function(hsl) {
                   if (hsl){
                    $("#edit_id").val(hsl.id);
                    $("#edit_id_category").val(hsl.id_category);
                    $("#edit_sub_category").val(hsl.name);
                    $("#editModal").modal();
